...
public class FXMLCheckOutController implements FXMLController{
	...
	public void setLibraryMember(int memberID){
	    this.member = new UserService().searchMember(memberID);
	}
	
	public void setPublication(String bookISBN){
		this.pub = new BookService().getBookByISBN(bookISBN);
	}
	public void setPublication(String pubTitle, String issueNumber){
		this.pub = new PeriodicalService().getPeriodical(issueNumber, pubTitle);
	}
	...
	boolean setMemberID(){
		if (!emptyWarning(memberID.getText(), "Member ID")){
			...
			setLibraryMember(Integer.parseInt(memberID.getText()));
			if (this.member == null){
	...
	private boolean setCopy(){
		...
		if (this.copy == null){
			...
			this.copy.setMemberID(Integer.parseInt(memberID.getText()));
			return true;
		}
	}
	...
	public boolean saveCheckOutRecord(){
		...
		copy.setMemberID(Integer.parseInt(memberID.getText()));
		...
		new UserService().addUser(this.member);
		return true;
	}
